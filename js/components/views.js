...
export class AdwViewSwitcher extends HTMLElement {
    ...
    constructor() { super(); this.attachShadow({ mode: 'open' }); const styleLink = document.createElement('link'); styleLink.rel = 'stylesheet'; styleLink.href = (typeof Adw !== 'undefined' && Adw.config && Adw.config.cssPath) ? Adw.config.cssPath : 'adwaita-web.css'; this.shadowRoot.appendChild(styleLink); this._viewSwitcherInstance = null; this._observer = null; }
...
export class AdwTabButton extends HTMLElement {
    ...
    constructor() { super(); this.attachShadow({ mode: 'open' }); const styleLink = document.createElement('link'); styleLink.rel = 'stylesheet'; styleLink.href = (typeof Adw !== 'undefined' && Adw.config && Adw.config.cssPath) ? Adw.config.cssPath : 'adwaita-web.css'; this.shadowRoot.appendChild(styleLink); this._tabButtonElement = null; }
...
export class AdwTabBar extends HTMLElement {
    ...
    constructor() { super(); this.attachShadow({ mode: 'open' }); const styleLink = document.createElement('link'); styleLink.rel = 'stylesheet'; styleLink.href = (typeof Adw !== 'undefined' && Adw.config && Adw.config.cssPath) ? Adw.config.cssPath : 'adwaita-web.css'; this.shadowRoot.appendChild(styleLink); this._tabBarElement = null; this._slotObserver = new MutationObserver(() => this._rebuildTabsFromSlotted());}
...
export class AdwTabPage extends HTMLElement {
    ...
    constructor() { super(); this.attachShadow({mode:'open'}); const styleLink = document.createElement('link'); styleLink.rel='stylesheet'; styleLink.href = (typeof Adw !== 'undefined' && Adw.config && Adw.config.cssPath) ? Adw.config.cssPath : 'adwaita-web.css'; const slot = document.createElement('slot'); this._wrapper = document.createElement('div'); this._wrapper.classList.add('adw-tab-page'); this._wrapper.setAttribute('role', 'tabpanel'); this._wrapper.appendChild(slot); this.shadowRoot.append(styleLink, this._wrapper);}
...
export class AdwTabView extends HTMLElement { /* ... (Same as original AdwTabView WC, ensure Adw.createTabView is local) ... */
    ...
    constructor() { super(); this.attachShadow({ mode: 'open' }); const styleLink = document.createElement('link'); styleLink.rel = 'stylesheet'; styleLink.href = (typeof Adw !== 'undefined' && Adw.config && Adw.config.cssPath) ? Adw.config.cssPath : 'adwaita-web.css'; this.shadowRoot.appendChild(styleLink); this._tabViewFactoryInstance = null; this._pagesSlot = document.createElement('slot'); this.shadowRoot.appendChild(this._pagesSlot); /* Append slot here */ this._slotObserver = new MutationObserver(() => this._rebuildFactoryPages()); }
...
export class AdwNavigationView extends HTMLElement { /* ... (Same as original AdwNavigationView WC, ensure createAdwNavigationView is local) ... */
    ...
    constructor() { super(); this.attachShadow({ mode: 'open' }); const styleLink = document.createElement('link'); styleLink.rel = 'stylesheet'; styleLink.href = (typeof Adw !== 'undefined' && Adw.config && Adw.config.cssPath) ? Adw.config.cssPath : 'adwaita-web.css'; this.shadowRoot.appendChild(styleLink); this._navigationViewFactoryInstance = null; this._pagesSlot = document.createElement('slot'); this.shadowRoot.appendChild(this._pagesSlot); /* Append slot here */ this._slotObserver = new MutationObserver(() => this._rebuildFactoryPagesFromSlotted()); }
...
export class AdwToolbarView extends HTMLElement {
    ...
    constructor() { super(); this.attachShadow({ mode: 'open' }); const styleLink = document.createElement('link'); styleLink.rel = 'stylesheet'; styleLink.href = (typeof Adw !== 'undefined' && Adw.config && Adw.config.cssPath) ? Adw.config.cssPath : 'adwaita-web.css'; this._toolbarViewElement = document.createElement('div'); this._toolbarViewElement.classList.add('adw-toolbar-view'); this._topBarSlotContainer = document.createElement('div'); this._topBarSlotContainer.classList.add('adw-toolbar-view-top-bar'); this._topBarSlot = document.createElement('slot'); this._topBarSlot.name = 'top-bar'; this._topBarSlotContainer.appendChild(this._topBarSlot); this._contentSlotContainer = document.createElement('div'); this._contentSlotContainer.classList.add('adw-toolbar-view-content'); this._contentSlot = document.createElement('slot'); this._contentSlotContainer.appendChild(this._contentSlot); this._bottomBarSlotContainer = document.createElement('div'); this._bottomBarSlotContainer.classList.add('adw-toolbar-view-bottom-bar'); this._bottomBarSlot = document.createElement('slot'); this._bottomBarSlot.name = 'bottom-bar'; this._bottomBarSlotContainer.appendChild(this._bottomBarSlot); this._toolbarViewElement.append(this._topBarSlotContainer, this._contentSlotContainer, this._bottomBarSlotContainer); this.shadowRoot.append(styleLink, this._toolbarViewElement); this._slotObserver = new MutationObserver(() => this._updateBarVisibility()); }
...
export class AdwCarousel extends HTMLElement {
    ...
    constructor() { super(); this.attachShadow({ mode: 'open' }); const styleLink = document.createElement('link'); styleLink.rel = 'stylesheet'; styleLink.href = (typeof Adw !== 'undefined' && Adw.config && Adw.config.cssPath) ? Adw.config.cssPath : 'adwaita-web.css'; this.shadowRoot.appendChild(styleLink); this._carouselInstance = null; this._slotObserver = new MutationObserver(() => this._rebuildSlides()); }
...
export class AdwNavigationSplitView extends HTMLElement {
    ...
    constructor() { super(); this.attachShadow({ mode: 'open' }); const styleLink = document.createElement('link'); styleLink.rel = 'stylesheet'; styleLink.href = (typeof Adw !== 'undefined' && Adw.config && Adw.config.cssPath) ? Adw.config.cssPath : 'adwaita-web.css'; this.shadowRoot.appendChild(styleLink); this._splitViewInstance = null; this._slotObserver = null; }
    connectedCallback() {
        this._render();
